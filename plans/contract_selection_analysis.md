...
The OLSa and HybridOLSa bidders almost never select HIGH or LOW contracts. The R0 eval report (`docs/04_reports/r0/model_arc_r0.md`) shows:
...
| `docs/04_reports/r0/model_arc_r0.md` | R0 report with contract selection frequencies |
