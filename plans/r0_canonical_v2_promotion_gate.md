...
| G6 | Metric deltas reviewed | v1→v2 delta table with explanations | **PASS** | `docs/04_reports/r0/22_v1_v2_delta_review.md` — 3 sign reversals (all explained), 1 claim reversal (explained), 3 lost significances (mid-tier, non-blocking) |
