...
| Step 5: Promote plan to ACTIVE | PENDING | -- | -- | After human review settles the governing plan. Register Phase 1 sub-plan as first implementation target. |

## Active Sub-Plans

| Sub-Plan ID | File | Status | Blocking Step |
|-------------|------|--------|---------------|
| SP-0-01 | `sub/2026-03-14_phase0_foundation_lock.md` | in_progress | Step 1 |
