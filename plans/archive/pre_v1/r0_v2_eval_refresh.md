...
post-freeze (archived governance doc). `docs/04_reports/arc_d_v1/r0/archive/v1/` files are
v1 archives — do NOT update.

### Step 6f: Regenerate registry + dashboard artifacts

`docs/02_agent/MODEL_ARC_RUNS.md` (line 11) and `docs/04_reports/arc_d_v1/model_arc_d_dashboard.md`
