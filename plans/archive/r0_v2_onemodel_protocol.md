...
| v1.2 | 2026-03-03 | Execution complete: RETAIN separate models | Forward selection rejected contract indicators. Unified model delta = -0.10 (hybrid_olsa) / -0.14 (hybrid_olsa_full) vs baseline. Decision: RETAIN. Report: `docs/04_reports/r0/14_onemodel_decision.md`. |
