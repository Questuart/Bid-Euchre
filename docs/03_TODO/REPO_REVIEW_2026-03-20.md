...
| R20-6 | MEDIUM | `docs/01_core/schemas/hybrid_olsa_v1.md:93` | ~~References stale progression report path which does not exist~~ FIXED: replaced with generic placeholder | ~~File annotated "[not yet generated]"~~ | ~~Generate the progression report or update the reference~~ |
