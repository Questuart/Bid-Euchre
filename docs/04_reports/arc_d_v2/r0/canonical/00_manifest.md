...
| `behavior_by_bid_type.csv` | 952 bytes |
| `behavior_by_contract.csv` | 477 bytes |
| `behavior_summary.csv` | 1,338 bytes |
| `comparator_rankings.csv` | 511 bytes |
| `cross_rung_deltas.csv` | 71 bytes |
| `data_sanity.csv` | 2,014 bytes |
| `dataset_provenance.csv` | 1,011 bytes |
| `h2h_delta_matrix.csv` | 23,996 bytes |
| `h2h_tier_summary.csv` | 1,015 bytes |
| `hypothesis_outcomes.csv` | 48 bytes |
| `model_performance.csv` | 845 bytes |
...
|---|-------|------|------|--------|
| 1 | Competitive Dashboard | `dashboard_competitive.png` | 302,414 bytes | present |
| 2 | Health Dashboard | `dashboard_health.png` | 179,225 bytes | present |
| 3 | Model Evaluation Dashboard | `dashboard_model_eval.png` | 108,048 bytes | present |
| 4 | Comparator Ranking Bars | `full_chart_suite/comparator_ranking_bars.png` | 42,562 bytes | present |
| 5 | Tail Risk Panel | `full_chart_suite/tail_risk_panel.png` | 39,754 bytes | present |
| 6 | H2H Delta by Contract | `full_chart_suite/delta_bars_by_contract.png` | 680,726 bytes | present |
| 7 | H2H Heatmap | `full_chart_suite/h2h_heatmap.png` | 135,454 bytes | present |
| 8 | H2H Ranking Scatter | `full_chart_suite/h2h_ranking_scatter.png` | 54,568 bytes | present |
| 9 | Outcome Distributions | `full_chart_suite/outcome_distributions.png` | 87,564 bytes | present |
| 10 | Seat Balance | `full_chart_suite/seat_balance.png` | - | absent |
| 11 | Contract Mix | `full_chart_suite/contract_mix_bars.png` | 38,392 bytes | present |
| 12 | Bid and Make Rates | `full_chart_suite/bid_behavior_panel.png` | 49,354 bytes | present |
| 13 | Bid Level Distribution | `full_chart_suite/bid_level_distribution.png` | 39,870 bytes | present |
| 14 | R-squared by Contract | `full_chart_suite/r2_by_contract.png` | 35,834 bytes | present |
| 15 | MAE by Contract | `full_chart_suite/mae_by_contract.png` | 34,660 bytes | present |
...
| 19 | Selection Path | `full_chart_suite/selection_path.png` | 105,207 bytes | present |
| 20 | Feature Importance | `full_chart_suite/feature_importance.png` | 94,416 bytes | present |
...
| 23 | Intelligence-Faceted H2H | `full_chart_suite/h2h_intelligence_faceted.png` | 56,828 bytes | present |
| - | full_chart_suite/outcome_summary.png | `full_chart_suite/outcome_summary.png` | 48,276 bytes | present |

## Chart Data

| Name | Size |
|------|------|
| `bid_levels.csv` | 267 bytes |
| `contract_mix.csv` | 787 bytes |
| `feature_importances.csv` | 6,077 bytes |
| `h2h_by_contract.csv` | 14,525 bytes |
| `outcome_distributions.csv` | 919 bytes |
| `outcome_summary.csv` | 1,338 bytes |
| `selection_paths.csv` | 8,384 bytes |
