...
| 3 | Model Evaluation Dashboard | `dashboard_model_eval.png` | 281,257 bytes | present |
...
| 16 | Predicted vs Actual | `full_chart_suite/pred_vs_actual.png` | 82,813 bytes | present |
| 17 | Residual Distribution | `full_chart_suite/residual_distribution.png` | 36,482 bytes | present |
| 18 | Calibration Curve | `full_chart_suite/calibration_curve.png` | 48,213 bytes | present |
