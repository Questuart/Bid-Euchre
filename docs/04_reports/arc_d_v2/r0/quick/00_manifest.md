...
| `sanity_bounds_check.csv` | 1,485 bytes |

## Charts

| # | Title | File | Size | Status |
|---|-------|------|------|--------|
| 1 | Competitive Dashboard | `dashboard_competitive.png` | 265,461 bytes | present |
| 2 | Health Dashboard | `dashboard_health.png` | 153,066 bytes | present |
| 3 | Model Evaluation Dashboard | `dashboard_model_eval.png` | 108,426 bytes | present |
| 4 | Comparator Ranking Bars | `full_chart_suite/comparator_ranking_bars.png` | 25,709 bytes | present |
...
| 8 | H2H Ranking Scatter | `full_chart_suite/h2h_ranking_scatter.png` | 46,762 bytes | present |
| 9 | Outcome Distributions | `full_chart_suite/outcome_distributions.png` | 92,565 bytes | present |
...
| 12 | Bid and Make Rates | `full_chart_suite/bid_behavior_panel.png` | 40,138 bytes | present |
| 13 | Bid Level Distribution | `full_chart_suite/bid_level_distribution.png` | 33,605 bytes | present |
