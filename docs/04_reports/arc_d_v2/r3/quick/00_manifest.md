...
| Name | Schema | Path |
|------|--------|------|
| evidence_manifest | arc_d_evidence_manifest_v1 | `docs/04_reports/arc_d_v2/r3/quick/evidence_manifest.json` |
...
| `behavior_summary.csv` | 1,549 bytes |
...
|---|-------|------|------|--------|
| 1 | Competitive Dashboard | `dashboard_competitive.png` | 301,931 bytes | present |
| 2 | Health Dashboard | `dashboard_health.png` | 180,164 bytes | present |
| 3 | Model Evaluation Dashboard | `dashboard_model_eval.png` | 90,079 bytes | present |
| 4 | Comparator Ranking Bars | `full_chart_suite/comparator_ranking_bars.png` | 42,261 bytes | present |
| 5 | Tail Risk Panel | `full_chart_suite/tail_risk_panel.png` | 39,766 bytes | present |
| 6 | H2H Delta by Contract | `full_chart_suite/delta_bars_by_contract.png` | 717,564 bytes | present |
| 7 | H2H Heatmap | `full_chart_suite/h2h_heatmap.png` | 130,127 bytes | present |
| 8 | H2H Ranking Scatter | `full_chart_suite/h2h_ranking_scatter.png` | 55,716 bytes | present |
...
| 12 | Bid and Make Rates | `full_chart_suite/bid_behavior_panel.png` | 49,479 bytes | present |
| 13 | Bid Level Distribution | `full_chart_suite/bid_level_distribution.png` | - | absent |
| 14 | R-squared by Contract | `full_chart_suite/r2_by_contract.png` | 38,196 bytes | present |
| 15 | MAE by Contract | `full_chart_suite/mae_by_contract.png` | 40,601 bytes | present |
...
| 23 | Intelligence-Faceted H2H | `full_chart_suite/h2h_intelligence_faceted.png` | 56,195 bytes | present |
| - | full_chart_suite/outcome_summary.png | `full_chart_suite/outcome_summary.png` | 48,772 bytes | present |
