...
| 2 | Health Dashboard | `dashboard_health.png` | 181,813 bytes | present |
| 3 | Model Evaluation Dashboard | `dashboard_model_eval.png` | 115,022 bytes | present |
...
| 9 | Outcome Distributions | `full_chart_suite/outcome_distributions.png` | 83,613 bytes | present |
...
| 13 | Bid Level Distribution | `full_chart_suite/bid_level_distribution.png` | 39,738 bytes | present |
...
| - | full_chart_suite/outcome_summary.png | `full_chart_suite/outcome_summary.png` | 48,866 bytes | present |
