...
| h2h_battery_smoke_42 | h2h_battery_v2 | `/Users/claude_runner/Projects/Bid-Euchre-meta/Bid-Euchre/data/artifacts/arc_d_v2/r3/h2h_battery_smoke_42.json` |
...
| `behavior_by_bid_type.csv` | 995 bytes |
| `behavior_by_contract.csv` | 474 bytes |
| `behavior_summary.csv` | 1,325 bytes |
| `comparator_rankings.csv` | 516 bytes |
| `cross_rung_deltas.csv` | 71 bytes |
| `data_sanity.csv` | 2,012 bytes |
| `dataset_provenance.csv` | 1,056 bytes |
| `h2h_delta_matrix.csv` | 24,647 bytes |
| `h2h_tier_summary.csv` | 1,010 bytes |
| `hypothesis_outcomes.csv` | 48 bytes |
| `model_performance.csv` | 852 bytes |
| `rung_model_spec.csv` | 440 bytes |
| `sanity_bounds_check.csv` | 1,882 bytes |

## Charts

| # | Title | File | Size | Status |
|---|-------|------|------|--------|
| 1 | Competitive Dashboard | `dashboard_competitive.png` | 307,706 bytes | present |
| 2 | Health Dashboard | `dashboard_health.png` | 179,216 bytes | present |
| 3 | Model Evaluation Dashboard | `dashboard_model_eval.png` | 106,642 bytes | present |
| 4 | Comparator Ranking Bars | `full_chart_suite/comparator_ranking_bars.png` | 44,067 bytes | present |
| 5 | Tail Risk Panel | `full_chart_suite/tail_risk_panel.png` | 39,750 bytes | present |
| 6 | H2H Delta by Contract | `full_chart_suite/delta_bars_by_contract.png` | 691,575 bytes | present |
| 7 | H2H Heatmap | `full_chart_suite/h2h_heatmap.png` | 130,792 bytes | present |
| 8 | H2H Ranking Scatter | `full_chart_suite/h2h_ranking_scatter.png` | 57,525 bytes | present |
| 9 | Outcome Distributions | `full_chart_suite/outcome_distributions.png` | 80,205 bytes | present |
| 10 | Seat Balance | `full_chart_suite/seat_balance.png` | - | absent |
| 11 | Contract Mix | `full_chart_suite/contract_mix_bars.png` | 38,367 bytes | present |
| 12 | Bid and Make Rates | `full_chart_suite/bid_behavior_panel.png` | 50,990 bytes | present |
| 13 | Bid Level Distribution | `full_chart_suite/bid_level_distribution.png` | 39,861 bytes | present |
| 14 | R-squared by Contract | `full_chart_suite/r2_by_contract.png` | 36,075 bytes | present |
| 15 | MAE by Contract | `full_chart_suite/mae_by_contract.png` | 35,330 bytes | present |
...
| 19 | Selection Path | `full_chart_suite/selection_path.png` | 98,950 bytes | present |
| 20 | Feature Importance | `full_chart_suite/feature_importance.png` | 81,945 bytes | present |
...
| 23 | Intelligence-Faceted H2H | `full_chart_suite/h2h_intelligence_faceted.png` | 56,540 bytes | present |
| - | full_chart_suite/outcome_summary.png | `full_chart_suite/outcome_summary.png` | 52,354 bytes | present |

## Chart Data

| Name | Size |
|------|------|
| `bid_levels.csv` | 265 bytes |
| `contract_mix.csv` | 780 bytes |
| `feature_importances.csv` | 10,236 bytes |
| `h2h_by_contract.csv` | 14,170 bytes |
| `outcome_distributions.csv` | 848 bytes |
| `outcome_summary.csv` | 1,261 bytes |
| `selection_paths.csv` | 13,355 bytes |
