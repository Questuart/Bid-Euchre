...
| `behavior_by_bid_type.csv` | 847 bytes |
| `behavior_by_contract.csv` | 277 bytes |
| `behavior_summary.csv` | 1,207 bytes |
| `comparator_rankings.csv` | 320 bytes |
...
| `sanity_bounds_check.csv` | 1,483 bytes |

## Charts

| # | Title | File | Size | Status |
|---|-------|------|------|--------|
| 1 | Competitive Dashboard | `dashboard_competitive.png` | 263,782 bytes | present |
| 2 | Health Dashboard | `dashboard_health.png` | 153,157 bytes | present |
| 3 | Model Evaluation Dashboard | `dashboard_model_eval.png` | 111,797 bytes | present |
| 4 | Comparator Ranking Bars | `full_chart_suite/comparator_ranking_bars.png` | 25,624 bytes | present |
| 5 | Tail Risk Panel | `full_chart_suite/tail_risk_panel.png` | 26,263 bytes | present |
...
| 8 | H2H Ranking Scatter | `full_chart_suite/h2h_ranking_scatter.png` | 43,163 bytes | present |
| 9 | Outcome Distributions | `full_chart_suite/outcome_distributions.png` | 85,452 bytes | present |
