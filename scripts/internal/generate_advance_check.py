#!/usr/bin/env python
"""
Generate advance check for a rung in the Arc D v2 lineage.

Evaluates hypotheses from hypotheses.json against generated tables,
runs sufficiency and canary checks, and outputs a machine-readable
advance_check.json with a PROCEED/INVESTIGATE/PAUSE decision.
